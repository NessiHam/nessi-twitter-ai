...
@click.command()
@click.option('--character-config', default='./config/characters/Nessi.yaml', help='Path to character config')
@click.option('--tasks-config', default='./config/tasks/Nessi.yaml', help='Path to tasks config')
